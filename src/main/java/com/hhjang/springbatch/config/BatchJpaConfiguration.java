...
@EnableJpaRepositories(
        basePackages = BatchJpaConfiguration.PACKAGE,
        entityManagerFactoryRef = BatchJpaConfiguration.MASTER_ENTITY_MANAGER_FACTORY, // default와 같아서 생략도 가능
        transactionManagerRef = BatchJpaConfiguration.MASTER_TX_MANAGER
)
public class BatchJpaConfiguration {
    public static final String PACKAGE = "com.hhjang.springbatch.entity";
